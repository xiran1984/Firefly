...
export const timeline = [
  {
    ...
    role: "FDE",
    highlights: [
      "负责 Web 工作台、内容生成、RPA 自动化和数据复盘模块的开发与整合；搭建类似 LibTV 的内容生成无限画布。",
      "创建公司内容创作 Skill，涵盖公众号、PPT 和公司官网。",
      "帮助 10 余位客户搭建基于飞书多维表格的抖音自动上架 RPA 流程，并在飞书多维表格内搭建图片生成工作台。",
      "对接客户询问 AI 落地需求，规划排期、需求范围划定与验收标准，参与售前咨询和业务调研、售后服务与咨询。",
      "负责边界测试与客户项目交付，跟进后续功能迭代与维护。",
      "部署本地数据库、知识库和大模型。",
      "担任 AI 训练营助教，负责演讲与答疑。",
    ],
  },
  {
    period: "2025.12 - 2025.4",
    company: "江苏龙道数据集团",
    role: "AI 产品经理",
    highlights: [
